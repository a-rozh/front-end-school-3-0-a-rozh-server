 ...
 */
export const getAllTracks: RouteHandler<ListTracksQuery> = async (request, reply) => {
    try {
 ...
 */
export const getTrack: RouteHandler<GetTrackParams> = async (request, reply) => {
    try {
 ...
 * Create a new track
 */
export const addTrack: RouteHandler<CreateTrackRequest> = async (request, reply) => {
    try {
        ...
        if (existingTrack) {
            return reply
                .code(409)
                .send({ error: 'A track with this title already exists' });
        }
 ...
 */
export const removeTrack: RouteHandler<GetTrackByIdParams> = async (request, reply) => {
    try {
        const { id } = request.params;
        ...
        await request.server.radioService.refreshTrackList();
 ...
 */
export const removeTracks: RouteHandler<DeleteTracksRequest> = async (request, reply) => {
    try {
 ...
 */
export const uploadTrackFile: RouteHandler<FileUploadParams> = async (request, reply) => {
    try {
        const { id } = request.params;
 ...
 */
export const deleteTrackFile: RouteHandler<FileUploadParams> = async (request, reply) => {
    try {
        const { id } = request.params;
